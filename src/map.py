...
class GridMap(object):
    ...
    def map_callback(self, data):
        ...
        self.width = int(data.info.width * self.resolution)
        self.height = int(data.info.height * self.resolution)
    ...
    def get_marker_xy(self, marker):
        ...
        o = marker.pose.orientation.z
        return x, y, o

    def set_start(self, data):
        x, y, o = self.get_marker_xy(data)
        self.start = (x, y, o)
